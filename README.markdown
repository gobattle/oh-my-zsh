...
```shell
sh -c "$(wget https://raw.github.com/gobattle/oh-my-zsh/master/tools/install.sh -O -)"
```
...
```shell
export ZSH="$HOME/.dotfiles/oh-my-zsh"; sh -c "$(curl -fsSL https://raw.github.com/gobattle/oh-my-zsh/master/tools/install.sh)"
```
...
```shell
git clone git://github.com/gobattle/oh-my-zsh.git ~/.oh-my-zsh
```
